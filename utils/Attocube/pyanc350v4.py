...
import utils.Attocube.ANC350libv4 as ANC
...
class Positioner:
    ...
    def __init__(self, devID):
        self.device = self.connect(devID)
    ...
    def getDeviceInfo(self, devNo=0):
        ...
        ANC.getDeviceInfo(devNo, ctypes.byref(devType), ctypes.byref(id_), ctypes.byref(serialNo),
