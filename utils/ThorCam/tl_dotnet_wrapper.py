...
clr.AddReference('utils/ThorCam/Thorlabs.TSI.TLCamera')
clr.AddReference('utils/ThorCam/Thorlabs.TSI.TLCameraInterfaces')
clr.AddReference('utils/ThorCam/Thorlabs.TSI.ImageData')
clr.AddReference('utils/ThorCam/Thorlabs.TSI.ColorInterfaces')
